...
CREATE TABLE IF NOT EXISTS global_counters(
	gc_id INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
	u_id INT UNSIGNED NOT NULL,
	email_response INT UNSIGNED DEFAULT 0,
	resume_request INT UNSIGNED DEFAULT 0,
	msg_or_call INT UNSIGNED DEFAULT 0,
	CONSTRAINT user_gcounter_relationship FOREIGN KEY(u_id) REFERENCES users(u_id)
);
...
CREATE TABLE IF NOT EXISTS std_iiscript_Qs(
	stdq_id INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
	text VARCHAR(2048),
	created DATETIME DEFAULT CURRENT_TIMESTAMP,
	updated DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
-- for creating iiscripts
-- getIIScriptQs() will return all std_iiscript_Qs & user_iiscript_Qs by that user.
CREATE TABLE IF NOT EXISTS user_iiscript_Qs(
	uq_id INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
	u_id INT UNSIGNED NOT NULL,
	text VARCHAR(2048),
	created DATETIME DEFAULT CURRENT_TIMESTAMP,
	updated DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
